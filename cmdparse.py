...
def ping_args() -> argparse.Namespace:
    ...
    argParser.add_argument("-c", "--ping-count", help="Amount of pings to send.")
    argParser.add_argument("-d", "--destination", help="Destination to ICMP packets, pings or traceroute.")
